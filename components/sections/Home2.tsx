		...
		<>
			...
			<section id="about" className="section-hero-2 position-relative pt-130 pb-3">
							...
							<div className="row align-items-end py-60">
								<div className="col-lg-5 ps-lg-5 text-lg-start text-center">
									<div className="position-relative mb-lg-0 mb-5">
										<img src="assets/imgs/home-page-2/hero-1/people.png" alt="Eduardo Mascarenhas" />
										<div className="position-absolute end-0 top-100 translate-middle-y icon-decorate">
											<img src="assets/imgs/home-page-2/hero-1/icon.svg" alt="Eduardo Mascarenhas" />
										</div>
									</div>
								</div>
										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">👋 Olá, prazer! Sou Eduardo</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3">Sou um desenvolvedor <span className="text-linear-4">{'{'}Full Stack{'}'}</span> especializado em aplicações Web, APIs &amp; Apps Móveis<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">Tenho experiência sólida com tecnologias modernas como</span> <span className="text-secondary-2">NodeJS</span>, <span className="text-secondary-2">React</span>, <span className="text-secondary-2">GraphQL</span> e <span className="text-secondary-2">AWS</span><span className="text-dark"> entregando soluções web inovadoras, escaláveis e de alta performance.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
											...
											<div className="col-5 d-flex align-items-end">
												<span className="fs-6 text-300 mb-2">...e mais</span>
											</div>
										</div>
				...
				<div className="background position-absolute top-0 start-0 w-100 h-100">
					<img className="bg-w" src="assets/imgs/home-page-2/hero-1/bg.png" alt="Eduardo Mascarenhas" />
					<img className="bg-d" src="assets/imgs/home-page-2/hero-1/bg-dark.png" alt="Eduardo Mascarenhas" />
				</div>
			</section>
