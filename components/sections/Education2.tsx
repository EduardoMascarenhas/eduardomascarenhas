							...
							<div className="rounded-3 border border-1 position-relative h-100 overflow-hidden">
								<div className="box-linear-animation p-md-6 p-3 ">
									<div className="d-flex align-items-center">
										...
										<h2 className="mb-0 ms-2">Educação</h2>
									</div>
									<div className="d-flex flex-column h-100 position-relative mt-5">
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2019-2021:</p>
													<div>
														<span className="text-primary-2">Estácio de Feira de Santana</span>
														<p className="text-dark">Análise e Desenvolvimento de Sistemas</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
