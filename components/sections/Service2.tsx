              ...
              <div className="position-relative z-1">
                <div className="text-center">
                  ...
                  <h3>
                    ...
                    para atingir os <span className="text-300">SEUS</span>{" "}
                    requisitos
                  </h3>
                </div>
                <div className="container mt-5">
                  <div className="row g-4">
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          e utilizo alguns dos frameworks mais atuais como
                          React.js e Vue.js, oferecendo experiências fluidas em
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          relacionais e NoSQL, com domínio em tecnologias como{" "}
                          <span className="text-secondary-2">MySQL</span>,{" "}
                          <span className="text-secondary-2">PostgreSQL</span> e{" "}
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          promovendo uma comunicação eficaz e segura entre o
                          front-end e o back-end, com foco em escalabilidade e
                          desempenho.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Aprimoramento de desempenho e tempo de resposta de
                          aplicações web para uma experiência do usuário
                          superior, utilizando tecnologias como{" "}
                          <span className="text-secondary-2">Nodejs</span> e{" "}
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          Desenvolvimento de soluções escaláveis e seguras para
                          plataformas de{" "}
                          <span className="text-secondary-2"> e-commerce </span>{" "}
                    ...
                    <div className="col-lg-4 col-md-6">
                      <div className="card-servies-2 rounded-2 h-100 hover-up">
                        ...
                        <p className="fs-7 text-300 fw-regular">
                          ...
                          <span className="text-secondary-2"> IA </span> para
                          otimizar processos, automatizar tarefas e oferecer
                          experiências personalizadas e inteligentes aos
                          usuários.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="text-center pt-60">
                    <p className="text-300">
                      Estou empolgado para participar de{" "}
                      <span className="text-dark">novos projetos</span> e
                      colaborar com você. <br />
